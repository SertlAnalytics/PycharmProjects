...
if True:
    ...
    stock_db_updater.update_wave_data_by_index_for_daily_period(INDICES.Q_FSE, 400, start_after='HDD')
    # stock_db_updater.update_wave_data_by_index_for_intraday(INDICES.Q_FSE, offset_day_range=15, start_after='000AIXA')
