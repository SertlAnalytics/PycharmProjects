...
from salesman_dash.my_dash_header_tables import MyHTMLTabRecommenderHeaderTable
from salesman_dash.my_dash_tab_dd_for_tutti import RecommenderTabDropDownHandler, REDD
from dash import Dash
from sertl_analytics.mydates import MyDate
from sertl_analytics.constants.pattern_constants import PRD, INDICES
from salesman_dash.my_dash_tab_table_for_tutti import RecommenderTable, RDC
...
class MyDashTab4Recommender(MyDashBaseTab):
    ...
    def __init__(self, app: Dash, sys_config: SystemConfiguration):
        ...
        self._recommender_table = RecommenderTable(None, None)
