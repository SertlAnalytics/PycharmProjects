...
from salesman_dash.my_dash_tab_dd_for_jobs import JOBDD, JobsTabDropDownHandler
from salesman_database.salesman_access_layer import AccessLayer4Process, AccessLayer4Offer
