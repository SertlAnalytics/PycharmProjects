...
from salesman_database.salesman_data_provider import SalesmanDataProvider
...
class RecommenderTable:
    def __init__(self, db_salesman: SalesmanDatabase, data_provider: SalesmanDataProvider):
    ...
    def __init_data_from_database__(self, initialize: bool):
        self._wave_df = self._db_salesman.get_wave_records_for_recommender_as_dataframe(400)
